...
// --- Icons ---
import { BoldIcon } from "@/components/titap/tiptap-icons/bold-icon"
import { Code2Icon } from "@/components/titap/tiptap-icons/code2-icon"
import { ItalicIcon } from "@/components/titap/tiptap-icons/italic-icon"
import { StrikeIcon } from "@/components/titap/tiptap-icons/strike-icon"
import { SubscriptIcon } from "@/components/titap/tiptap-icons/subscript-icon"
import { SuperscriptIcon } from "@/components/titap/tiptap-icons/superscript-icon"
import { UnderlineIcon } from "@/components/titap/tiptap-icons/underline-icon"
