...
export default function CustomerBookingListPage() {
  ...
  const filteredBookings = bookingData.filter((booking) => {
    ...
    const matchesSearch = booking.roomName
      .toLowerCase()
                ...
                >
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="md:w-80 h-64 md:h-auto relative overflow-hidden">
                      ...
                      />
                      <div
                        className={`absolute top-4 right-4 px-3 py-1 rounded-full border ${statusConfig.color} flex items-center gap-1 font-semibold text-sm backdrop-blur-sm`}
                      >
