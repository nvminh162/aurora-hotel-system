...
import RoomEventDetailPage from "@/pages/rooms/RoomEventDetail";
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "room-events/:id", element: <RoomEventDetailPage /> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "branches/:branchId/assign-manager", element: <AssignBranchPage /> },
      { path: "users", element: <UserListPage /> },
      { path: "users/upsert", element: <UserUpsertPage /> },
      { path: "users/detail", element: <UserDetailPage /> },
